...
/*   Updated: 2017/05/23 12:05:00 by czalewsk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				parse(t_list *list_lex, t_list *label, t_header *header);
...
void				fill_header(t_header *header, t_list *list_lex, t_buf
*buffer);

void				param_to_buffer(t_buf *buffer, t_list **list_lex,
t_op *op, t_list *list_label);

void				set_codage(unsigned char *codage, t_list *list_lex,
t_op *op);
